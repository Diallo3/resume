 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Opus
...
add_action( 'tgmpa_register', 'opus_register_required_plugins' );
 ...
 */
function opus_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'       => 'https://s3.amazonaws.com/gravityforms/releases/checksums/gravityforms_2.0.7.4.md5', // The plugin source.
			'required'     => false, // If false, the plugin is only 'recommended' instead of required.
			'external_url' => '', // If set, overrides default API URL and points to an external URL.
		),
	 ...
	 */
	$config = array(
		'id'           => 'opus',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'opus' ),
			'menu_title'                      => __( 'Install Plugins', 'opus' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'opus' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'opus' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'opus' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'opus' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'opus' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'opus' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'opus' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'opus' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'opus' ),
			'dismiss'                         => __( 'Dismiss this notice', 'opus' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'opus' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'opus' ),
